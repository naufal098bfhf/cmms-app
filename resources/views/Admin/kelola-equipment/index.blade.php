...
<div class="p-6 bg-white rounded-2xl shadow-lg">
    ...
    <!-- Form Pencarian -->
    <form method="GET" action="{{ route('admin.kelola-equipment.index') }}" class="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 mb-6">
        ...
        <a href="{{ route('admin.kelola-equipment.create') }}"
           class="w-full md:w-auto md:ml-auto bg-red-400 hover:bg-red-500 text-white px-4 py-2 rounded-lg text-center" hover:bg-red-500 text-white px-4 py-2 rounded-lg">
            Tambah Baru
        </a>
    </form>
    ...
    <div class="flex justify-center items-center gap-3">
                        ...
                        {{-- Edit --}}
                        <a href="{{ route('admin.kelola-equipment.edit', $item->id) }}"
                        ...
                        {{-- Hapus --}}
                        <form method="POST" action="{{ route('admin.kelola-equipment.destroy', $item->id) }}">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
