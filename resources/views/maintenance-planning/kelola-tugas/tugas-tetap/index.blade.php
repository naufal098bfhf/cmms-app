...
<div class="p-6 bg-white rounded-2xl shadow-lg">
    ...
    <!-- Filter Status -->
    <form method="GET" action="{{ route('maintenance-planning.kelola-tugas.tugas-tetap.index') }}" class="flex items-center gap-4 mb-6">
        ...
        <a href="{{ route('maintenance-planning.kelola-tugas.tugas-tetap.create') }}" class="ml-auto bg-rose-300 text-white px-4 py-2 rounded-lg hover:bg-rose-400">+ Tambah Tugas</a>
    </form>
                ...
                @forelse($tugasTetap as $tugas)
                    <tr class="text-center">
                        ...
                        <td class="px-4 py-2 border">
                            ...
                            @endphp
                        <span class="px-2 py-1 rounded-lg text-white whitespace-nowrap {{ $statusColors[$tugas->status] ?? 'bg-gray-400' }}">
                        ...
                        <td class="px-4 py-3 flex justify-center gap-3">
                            {{-- Edit --}}
                            <a href="{{ route('maintenance-planning.kelola-tugas.tugas-tetap.edit', $tugas->id) }}"
                            ...
                            {{-- Hapus --}}
                            <form method="POST" action="{{ route('maintenance-planning.kelola-tugas.tugas-tetap.destroy', $tugas->id) }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
